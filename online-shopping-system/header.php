			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +233 2076 1111 7</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> idaya.seidu@ashesi.edu.gh</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i>Asokore Mampong,Kumasi</a></li>
					</ul>
							...
							<div class="header-search">
								<form onsubmit="return false">
									<select class="input-select">
										...
										<option value="1">Safety devices</option>
